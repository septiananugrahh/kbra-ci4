          ...
          <div class="card-body">
            ...
            <div class="d-flex justify-content-between mb-10">
              ...
              <div class="d-flex gap-2">
                <button type="button" id="btn-salin-kurikulumcinta" class="btn btn-outline-primary">
                  <i class="ri-file-copy-line"></i> &nbsp;Salin dari Tahun Sebelumnya
                </button>
                <button type="button" id="btn-tambah-kurikulumcinta" class="btn btn-success">
...
<!-- Modal Salin Data -->
<div class="modal fade" id="modalSalinKurikulumCinta" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
...
<script type="text/javascript" language="javascript">
  $(document).ready(function() {
    ...
    $('#btn-salin-kurikulumcinta').on('click', function() {
      $('#modalSalinKurikulumCinta').modal('show');
    });
    ...
    $('#btn-proses-salin').on('click', function() {
      ...
      $.ajax({
        url: "<?= site_url('kurikulumcinta/salindata'); ?>",
        type: 'POST',
        data: {
        ...
        success: function(res) {
          if (res.status === 'sukses') {
            ...
            $('#modalSalinKurikulumCinta').modal('hide');
            dataTable_kurikulumcinta.ajax.reload();
          } else {
