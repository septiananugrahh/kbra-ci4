      ...
      <div class="record-card">
        <table class="table-anekdot">
          ...
          <tr>
            ...
            <td><?= nl2br(esc($record['tempat'])) ?></td>
            <td><?= nl2br(esc($record['peristiwa'])) ?></td>
            <td>
              ...
              if (!empty($record['keterangan'])) {
                ...
                $analisisData = json_decode($record['keterangan'], true);
                ...
                if (json_last_error() === JSON_ERROR_NONE) {
                  ...
                  foreach ($analisisData as $analisis) {
                    ...
                    $analisisText = htmlspecialchars($analisis['keterangan']);
                  ...
                  echo "Data catatan tidak valid (JSON parsing error).";
                }
              } else {
